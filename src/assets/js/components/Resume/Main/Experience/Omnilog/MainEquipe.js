        ...
        return (
            <MainMission title={text[this.props.locale].MainEquipe.title}>
                <dl>
                    ...
                    <dd>
                        <p>
                            {text[this.props.locale].MainEquipe.dd1.map(
                                (val) => {
                                    return (
                                        <span>
                                            {val}
                        ...
                        <ul>
                            <li>
                                Actions on Google, Dialogflow, Firebase, Node.JS
                                6
                            </li>
                        </ul>
                    </dd>
                    ...
                    <dt>
                        <strong>
                            {text[this.props.locale].MainEquipe.dt2}
                        </strong>
                    </dt>
                    <dd>
                        <p>
                            {text[this.props.locale].MainEquipe.dd2.map(
                                (val) => {
                                    return (
                                        <span>
                                            {val}
